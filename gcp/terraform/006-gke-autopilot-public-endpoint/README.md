...
# Proyecto Terraform GCP: GKE Autopilot con Endpoint Público

## Descripción
Este stack despliega un clúster GKE en modo **Autopilot** en Google Cloud Platform (GCP). El clúster tiene nodos privados y un endpoint de control plane público y accesible. Incluye la infraestructura de red, cuentas de servicio y todos los recursos necesarios para un clúster funcional y gestionado por Google.
