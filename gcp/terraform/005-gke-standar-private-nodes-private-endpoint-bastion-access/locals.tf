locals {
  ...
  region                          = var.region
  service_account_path            = "${path.module}/../.nogit/mdk-terraform-sa-markitos-mdk-gke.json"
  ...
  terraform_service_account_name  = var.terraform_gcp_service_account_name
  terraform_service_account_email = "${local.terraform_service_account_name}@${var.project_id}.iam.gserviceaccount.com"
